...
If undefined the default values for the `@AttrField`, `@StringField`, `@NumberField`, and `@BooleanField` decorator will
be:
...
* `@HasManyField` creates a [HasMany](https://vuex-orm.github.io/vuex-orm/guide/model/relationships.html#one-to-many)
  relationship field
* `@HasOneField` creates a [HasOne](https://vuex-orm.github.io/vuex-orm/guide/model/relationships.html#one-to-one)
  relationship field
* `@BelongsToField` creates an
  inverse [HasOne](https://vuex-orm.github.io/vuex-orm/guide/model/relationships.html#one-to-one-inverse) relationship
  field
* `@HasManyByField` creates
